...
%nonassoc else
%nonassoc '<' '>'
%nonassoc int true false doNull '(' ')' '{' '}'
$nonassoc tileline
--%nonassoc var
...
MultiTile : ExpTile MultiTile                   { MultiTile $1 $2}
          | ExpTile                             { $1 }
...
data ExpTile = Tile String ExpTile | String
} 